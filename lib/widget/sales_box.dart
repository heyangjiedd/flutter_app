...
class SalesBox extends StatelessWidget {
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12), gradient: LinearGradient(colors: [Color(0xffff4e63), Color(0xffff6cc9)], begin: Alignment.centerLeft, end: Alignment.centerRight)),
  ...
  Widget _item(BuildContext context, CommonModel model, bool big, bool left, bool last) {
    ...
    return GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(border: Border(right: left ? borderSide : BorderSide.none, bottom: last ? borderSide : BorderSide.none)),
          child: Image.network(
            model.icon,
            fit: BoxFit.fill,
