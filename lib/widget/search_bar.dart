...
class _SearchBarState extends State<SearchBar> {
  ...
  _inputBox() {
    Color inputBoxColor;
    inputBoxColor = widget.searchBarType == SearchBarType.home ? Colors.white : Color(int.parse('0xffEDEDED'));
    return Container(
      height: 30,
          ...
          Expanded(
            ...
            child: widget.searchBarType == SearchBarType.normal
                ? TextField(
                    ...
                    decoration:
                        InputDecoration(isDense: true, contentPadding: EdgeInsets.fromLTRB(5, 0, 5, 0), border: InputBorder.none, hintText: widget.hint ?? '', hintStyle: TextStyle(fontSize: 15)),
                  )
                : _wrapTap(
                    Container(
                      child: Text(
